...
using BhooterRajaDiloBor.Services;
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "BhooterRajaDiloBor", Version = "v1" });
...
//Inject context
builder.Services.AddTransient<BhooterRajaDiloBorContext>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "BhooterRajaDiloBor API v1");
